...
public class Customer
{
    ...
    private Vector<Rental> rentals = new Vector<Rental>();		//grownable array for Objects

    public Customer(String pName) {								//Konstruktor
        name = pName;
    }

    public void addRental(Rental pRental) {						//Adding Objects to
    ...
    {
        double lTotalAmount = 0;							//betrag gesamt
